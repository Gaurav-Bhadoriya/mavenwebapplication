...
//            Employee newEmployee = new Employee(name, age, salary, birthDate);
//            employeeService.addEmployee(newEmployee);
//                    EmployeeSkills employeeSkills = new EmployeeSkills(skills);
//                    employeeService.addEmployeeSkills(employeeSkills);
...
//        Set<String> employeeSkills = employeeService.getEmployeeSkillsByEmployeeId(employeeId);
//        request.setAttribute("employee", employee);
//        request.setAttribute("employeeSkills", employeeSkills);	
//        request.setAttribute("selectedSkills", employeeSkills);
//        RequestDispatcher dispatcher = request.getRequestDispatcher("/addEmployee.jsp");
//        dispatcher.forward(request, response);
//    }
//    
...
//                return;
//            }
//            Employee updatedEmployee = new Employee(employeeId, name, age, salary, birthDate);
//            EmployeeSkills updatedEmployeeSkills = new EmployeeSkills(skills);
//            updatedEmployeeSkills.setEmployeeId(employeeId);
//            employeeService.updateEmployee(updatedEmployee);
//            employeeService.updateEmployeeSkills(updatedEmployeeSkills);
//            System.out.println(updatedEmployeeSkills);
//            response.sendRedirect(request.getContextPath() + "/employee?action=list");
